<x-app-layout>
    <div x-data="{ pausedOpen: false, completedOpen: false }" class="max-w-6xl mx-auto p-4 sm:p-6 text-white">
        <h1 class="text-xl sm:text-2xl font-bold mb-6">🎛 Meus Animes</h1>
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-4">
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-300">
                                Progresso atual: episódio {{ $plan->current_episode_calculated ?? $plan->episodes_watched }}
                            </p>
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:flex sm:flex-wrap gap-2">
                                ...
                                <form method="POST" action="{{ route('personal.animes.complete', $plan->id) }}">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form method="POST" action="{{ route('personal.animes.destroy', $plan->id) }}"
                                      onsubmit="return confirm('Tem certeza que deseja excluir este anime do seu espaço?')">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-4 opacity-90">
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-300">
                                Pausado no episódio {{ $plan->current_episode_calculated ?? $plan->episodes_watched }}
                            </p>
                            ...
                            <div class="mt-4 grid grid-cols-1 sm:flex gap-2">
                                <form method="POST" action="{{ route('personal.animes.resume', $plan->id) }}">
                                    @csrf
                                    @method('PATCH')
                ...
                <div class="bg-gray-800 border border-gray-700 rounded-lg p-4 opacity-80">
                    <div class="flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-300">
                                Finalizado no episódio {{ $plan->current_episode_calculated ?? $plan->episodes_watched }}
                            </p>
