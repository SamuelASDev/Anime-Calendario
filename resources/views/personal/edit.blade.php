<x-app-layout>
    <div class="max-w-3xl mx-auto p-6 text-white">
        ...
        <div class="bg-gray-800 border border-gray-700 rounded-lg p-6">
            ...
            <form method="POST" action="{{ route('personal.animes.update', $plan->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        min="0"
                        value="{{ old('episodes_watched', $plan->episodes_watched) }}"
                        class="w-full rounded bg-gray-200 border border-gray-600 px-3 py-2"
                        style="color: #111827 !important; -webkit-text-fill-color: #111827 !important;"
                    >
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select
                        ...
                        style="color: #111827 !important; -webkit-text-fill-color: #111827 !important;"
                    >
                        <option value="assistindo" @selected(old('watch_status', $plan->watch_status) === 'assistindo')>
                            Assistindo
                        </option>
                        <option value="pausado" @selected(old('watch_status', $plan->watch_status) === 'pausado')>
                            Pausado
                        </option>
                        <option value="concluido" @selected(old('watch_status', $plan->watch_status) === 'concluido')>
                            Concluído
                        </option>
                    </select>
                </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-3">
                                <input
                                    ...
                                    name="{{ $info['name'] }}"
                                    min="0"
                                    value="{{ old($info['name'], $days[$dayNumber]->episodes_planned ?? 0) }}"
                                    class="w-full rounded bg-gray-200 border border-gray-600 px-3 py-2"
                                    style="color: #111827 !important; -webkit-text-fill-color: #111827 !important;"
                                >
                                ...
                                <label class="flex items-center gap-2 text-sm whitespace-nowrap">
                                    <input
                                        ...
                                        @checked(old($info['var'], $days[$dayNumber]->is_variable ?? false))
                                    >
                                    <span>Variado</span>
                                </label>
                            </div>
